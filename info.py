...
BOT_TOKEN = environ.get('BOT_TOKEN', '8643456010:AAGfbrBQAbwvv03mnnBtU5m_J7pRkV-lvgY')
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1003559364122'))
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1003559364122'))
